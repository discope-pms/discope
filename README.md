...
Cette option permet d'établir les permissions et restrictions pour les utilisateurs assignés à un groupe. Elle se trouve dans l'option Base, puis dans Sécurité.
...
### Configuration des paramètres de Configuraiton
...
- **Réduction** : Les réductions permettent d’offrir des avantages tarifaires aux clients selon des critères spécifiques. Chaque réduction se compose d’un libellé, d’une valeur, d’un type (pourcentage ou gratuité) et de conditions à remplir pour en bénéficier.
