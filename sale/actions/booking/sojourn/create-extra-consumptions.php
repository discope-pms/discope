...
$group = BookingLineGroup::id($params['id'])
    ->read([
        'id', 'nb_pers', 'is_extra', 'has_consumptions',
...
$assignments = SojournProductModelRentalUnitAssignement::search(['booking_line_group_id', '=', $params['id']])
    ->read(['id', 'qty', 'rental_unit_id'])
    ->get(true);
