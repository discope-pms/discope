...
list($params, $providers) = eQual::announce([
    ...
    'help'          => "After the operation, status of involved fundings and bookings are updated. This action is intended to be exclusively called on `sale\booking\Payment` entities.",
    'params'        => [
        'id' =>  [
