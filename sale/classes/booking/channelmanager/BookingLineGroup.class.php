...
class BookingLineGroup extends \sale\booking\BookingLineGroup {
    ...
    public static function getColumns() {
        return [
            ...
            'booking_id' => [
                'type'              => 'many2one',
                'foreign_object'    => 'sale\booking\channelmanager\Booking',
            ...
            'accomodations_ids' => [
                'type'              => 'one2many',
                'foreign_object'    => 'sale\booking\channelmanager\BookingLine',
                'foreign_field'     => 'booking_line_group_id',
            ...
            'age_range_assignments_ids' => [
                'type'              => 'one2many',
                'foreign_object'    => 'sale\booking\channelmanager\BookingLineGroupAgeRangeAssignment',
                'foreign_field'     => 'booking_line_group_id',
