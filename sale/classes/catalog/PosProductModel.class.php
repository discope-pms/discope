...
class PosProductModel extends \sale\catalog\ProductModel {
    ...
    public static function getColumns() {
        return [
            ...
            'categories_ids' => [
                ...
                'default'           => [2] // #todo - adapt to not use an hardcoded value
            ],
    ...
    public static function canupdate($om, $oids, $values, $lang='en') {
        ...
        if($product_models > 0 && count($product_models)) {
            foreach($product_models as $id => $product) {
                $centers_ids = array_map(function ($a) {return $a['center_id']; }, (array) $product['groups_ids.center_id']);
