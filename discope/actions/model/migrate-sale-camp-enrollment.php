...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for sale_camp_enrollment.',
    'params'        => [
        'confirm' => [
...
// Resolve every row to the concrete enrollment model.
$classify = static function (array $row) : string {
    return 'sale\\camp\\Enrollment';
};
