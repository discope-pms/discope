...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for finance_accounting_invoice.',
    'params'        => [
        'confirm' => [
...
$table = 'finance_accounting_invoice';
...
$classify = static function (array $row) : string {
    return !empty($row['booking_id']) ? 'sale\\booking\\Invoice' : 'finance\\accounting\\Invoice';
};
