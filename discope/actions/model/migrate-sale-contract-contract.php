...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for sale_contract_contract.',
    'params'        => [
        'confirm' => [
...
$classify = static function (array $row) : string {
    return !empty($row['booking_id']) ? 'sale\\booking\\Contract' : 'sale\\contract\\Contract';
};
