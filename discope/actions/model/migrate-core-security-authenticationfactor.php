...
$required_columns = ['id', 'model', 'type'];
...
$classify = static function (array $row) : string {
    switch($row['type'] ?? null) {
        case 'passkey':
            return 'core\\security\\factor\\Passkey';
        case 'totp':
            return 'core\\security\\factor\\TotpKey';
    }
    throw new Exception('invalid_authentication_factor_type', EQ_ERROR_INVALID_CONFIG);
};
