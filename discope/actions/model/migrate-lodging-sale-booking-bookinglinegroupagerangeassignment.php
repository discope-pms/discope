...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for lodging_sale_booking_bookinglinegroupagerangeassignment.',
    'params'        => [
        'confirm' => [
...
$table = 'lodging_sale_booking_bookinglinegroupagerangeassignment';
...
$required_columns = ['id', 'model', 'booking_id'];
...
$classify = static function (array $row) : string {
    return 'sale\\booking\\BookingLineGroupAgeRangeAssignment';
};
