...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for sale_pay_guarantee.',
    'params'        => [
        'confirm' => [
...
$classify = static function (array $row) : string {
    return !empty($row['booking_id']) ? 'sale\\booking\\Guarantee' : 'sale\\pay\\Guarantee';
};
