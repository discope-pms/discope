...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for sale_camp_guardian.',
    'params'        => [
        'confirm' => [
...
// Resolve every row to the concrete guardian model.
$classify = static function (array $row) : string {
    return 'sale\\camp\\Guardian';
};
