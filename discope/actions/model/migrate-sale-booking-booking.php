...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for sale_booking_booking.',
    'params'        => [
        'confirm' => [
...
$required_columns = ['id', 'model', 'is_from_channelmanager'];
