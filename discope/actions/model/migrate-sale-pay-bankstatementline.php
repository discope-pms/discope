...
[$params, $providers] = eQual::announce([
    'type'          => 'do',
    'name'          => 'migrate-sale-pay-bankstatementline',
    'package_name'  => 'core',
    'description'   => 'Migrate the model discriminator for sale_pay_bankstatementline.',
    'params'        => [
        'confirm' => [
...
$table = 'sale_pay_bankstatementline';
...
$classify = static function (array $row) : string {
    return 'sale\\booking\\BankStatementLine';
};
