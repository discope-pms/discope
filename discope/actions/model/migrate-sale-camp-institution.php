...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for sale_camp_institution.',
    'params'        => [
        'confirm' => [
...
// Resolve every row to the concrete institution model.
$classify = static function (array $row) : string {
    return 'sale\\camp\\Institution';
};
