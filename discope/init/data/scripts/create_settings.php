...
Setting::assert_value('sale', 'features', 'booking.employee_planning.booking_activity_card.line1', '{group_num} - {customer_name}');
Setting::assert_value('sale', 'features', 'booking.employee_planning.booking_activity_card.line2', '{activity_name}');
Setting::assert_value('sale', 'features', 'booking.employee_planning.camp_activity_card.line1', '{sojourn_number} - {group_num} - {activity_name}');
Setting::assert_value('sale', 'features', 'booking.employee_planning.camp_activity_card.line2', '{short_name}');
