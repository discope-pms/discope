...
# Windows : ng build --configuration production --output-hashing none --base-href="//app\\"
# Linux : ng build --configuration production --output-hashing none --base-href="/app/"
ng build --configuration production --output-hashing none --base-href="//employees\\"
