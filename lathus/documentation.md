...
Une tranche d'âge doit être assignée à un camp :
  - 6 à 9 ans
  - 10 à 12 ans
  - 13 à 16 ans

En fonction de la tranche d'âge les enfants logent dans un camping différent :

| Tranche d'âge |  Camping   |
|:-------------:|:----------:|
|   6 à 9 ans   |  criquets  |
|  10 à 12 ans  | libellules |
|  13 à 16 ans  | papillons  |

> **Notes** : Un enfant peut quand même être inscrit à un camp s'il a un an de plus ou de moins que la tranche d'âge du camp.
